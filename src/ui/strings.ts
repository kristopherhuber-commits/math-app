...
export const rewardStrings = {
  ...
  home: {
    ...
    streakLabel: 'streak',
    shellsLabel: 'shells',
    pipToday: (topic: string) => `Pip: ${topic} today? Let's go!`,
    pipStreak: (n: number) => `Pip: ${n}-day streak! Keep it up!`,
    pipFree: "Pip: Pick a topic. Let's play!",
    shelly: "Shelly's here if you get stuck.",
    freePractice: 'Free practice',
    freeLocked: "unlocks when today's assignment is done",
    freeNever: 'not open right now',
    locked: (topic: string) => `${topic}, locked`,
    badLink: "That assignment link couldn't be read.",
  },
  summary: {
